        ...
        <div className="overflow-x-auto pb-2">
          <div className="flex min-w-max gap-6 snap-x snap-mandatory">
            {dates.map((dayDate) => {
              ...
              return (
                <article key={dayDate} className={`snap-start min-w-[270px] rounded-2xl border p-3 ${rowClass} ${todayClass}`}>
